...
| [Folklore Clinical Variant Interpretation MCP](https://github.com/helena-bioinformatics/folklore-mcp) | ⭐⭐ B | 🟢 Active | ![](https://img.shields.io/github/stars/helena-bioinformatics/folklore-mcp?style=flat-square) | Official public Helena Bioinformatics MCP for supported GRCh38 germline variant interpretation, returning source-backed evidence, automated ACMG/AMP variant-level decision support, provenance, and related PubMed literature. Hosted Streamable HTTP endpoint, Apache-2.0 source, tests and CI, no patient context, and an explicit professional-review boundary. |
