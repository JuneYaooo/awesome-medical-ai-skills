...
| [Noodle Biomedical Literature Discovery MCP](https://github.com/helena-bioinformatics/noodle-mcp) | ⭐⭐ B | 🟢 Active | ![](https://img.shields.io/github/stars/helena-bioinformatics/noodle-mcp?style=flat-square) | Official public Helena Bioinformatics MCP and companion Agent Skill for natural-language or PMID/DOI/PMCID literature search, source-linked publication lookup, and bounded citation or semantic graph traversal. Hosted read-only Streamable HTTP endpoint, Apache-2.0 source, tests and CI; accepts no PHI or private case data. |
...
| [drug-discovery-agent-skills](https://github.com/K-Dense-AI/drug-discovery-agent-skills) | — | ⭐ C | 🟢 Active | ![](https://img.shields.io/github/stars/K-Dense-AI/drug-discovery-agent-skills?style=flat-square) | Agent Skills for small-molecule and protein therapeutics: cheminformatics, molecular ML, docking and dynamics, protein design platforms, and target-discovery knowledge graphs. |
| [Awesome-Endo-Adeno-Resources](https://github.com/bloo-berries/Awesome-Endo-Adeno-Resources) | — | ⭐ C | 🟢 Active | ![](https://img.shields.io/github/stars/bloo-berries/Awesome-Endo-Adeno-Resources?style=flat-square) | Comprehensively and confidently navigating Endometriosis and Adenomyosis and their comorbidities. #MaintainerMonth |
| [hcls-agent-skills](https://github.com/awslabs/hcls-agent-skills) | Claude Code | ⭐ C | 🟢 Active | ![](https://img.shields.io/github/stars/awslabs/hcls-agent-skills?style=flat-square) | Agent skills for healthcare and life sciences: genomics, imaging, claims, drug discovery, and more. Works with Amazon Quick, Kiro, Amazon AgentCore, AWS Strands SDK, Claude Code, Codex, and any Age... |
...
| [Awesome-TCM-LLM](https://github.com/tyang816/Awesome-TCM-LLM) | — | ⭐ C | 🟢 Active | ![](https://img.shields.io/github/stars/tyang816/Awesome-TCM-LLM?style=flat-square) | Open-source Traditional Chinese Medical Large Language Models. （开源中文医疗大模型合集） |
